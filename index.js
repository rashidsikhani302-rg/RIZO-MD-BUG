/**
   * Create By RIZO TOXIC OFFICIAL
   * Contact Me on 966532176778
*/
...
const initializeBot = async () => {
    ...
    console.log(chalk.green('   RIZO TOXIC 𝐩𝐚𝐢𝐫𝐢𝐧𝐠 𝐬𝐲𝐬𝐭𝐞𝐦       '));
    console.log(chalk.yellow('═══════════════════════════════════════════════\n'));
...
function launchBot() {
    console.clear();
    console.log(chalk.green('🚀 Starting RIZO TOXIC system...\n'));
    ...
    if (fs.existsSync(botPath)) {
        try {
            ...
            require('./bot');
            telegramLoaded = true;
            console.log(chalk.green('RIZO TOXIC bot loaded successfully!'));
        } catch (error) {
    ...
    console.log(chalk.bold.white('RIZO TOXIC BOT INITIALIZATION SUMMARY          '));
    console.log(chalk.cyan('═══════════════════════════════════════════════'));
    console.log(telegramLoaded ? chalk.green('✅ RIZO TOXIC тɛℓɛɢяαм вσт: Active') : chalk.red('❌ RIZO TOXIC тɛℓɛɢяαм вσт : Inactive'));
    ...
    if (!telegramLoaded && !whatsappLoaded) {
        ...
        console.log(chalk.green('✅ RIZO TOXIC system is ready and running!\n'));
    }
